...
setJourAbb = function () {
    ...
    var upJourAbb = document.getElementById('id-updateifs-up-abbr').checked;
     
    // 设置复选框
     document.getElementById('id-updateifs-dot-abbr').disabled = !upJourAbb;
     document.getElementById('id-updateifs-en-abbr').disabled = !upJourAbb;
     document.getElementById('id-updateifs-ch-abbr').disabled = !upJourAbb;
